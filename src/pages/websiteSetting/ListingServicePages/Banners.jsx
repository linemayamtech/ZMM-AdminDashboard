...
const Banners = () => {
  ...
  const [carouselImages, setCarouselImages] = useState([
    require("../../../assets/ListingService/people-learning-new-language-work.png"),
    require("../../../assets/ListingService/top-view-business-people-discussing-about-financial-strategy-directorate_31965-340080.png"),
    require("../../../assets/ListingService/business-professionals-reviewing-documents-meeting-table_305419-10752.png"),
  ]);
    ...
    <div className="mb-20">
      ...
      <div className="mx-auto">
        ...
        <div className="relative flex flex-col  group">
          ...
          <h1 className="text-3xl  pb-2 text-center font-semibold">Lisitng Banner Preview</h1>
        </div>
        <div
      ...
      {isModalOpen && (
        <div className="fixed pt-48 pb-20 inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 overflow-scroll">
          <div className="bg-white p-6  rounded-md w-[70%] relative  ">
            <button onClick={closeModal} className="text-red-500 hover:text-red-700 text-xl border-2 border-blood rounded-full px-2  absolute top-2 right-2">
              X
            </button>
